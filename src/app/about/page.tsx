        ...
        <>
            ...
            <main className="min-h-screen">
                <div className="container mx-auto px-4 py-12 max-w-4xl">
                    <h1 className="text-4xl font-bold mb-8 font-unbounded">About Conflict Wire</h1>
                    ...
                    <div className="prose prose-lg max-w-none">
                        ...
                        <h2 className="text-2xl font-bold font-unbounded mt-8 mb-4">Our Mission</h2>
                        <p className="mb-6">
                        ...
                        <h2 className="text-2xl font-bold font-unbounded mt-8 mb-4">What We Cover</h2>
                        ...
                        <div className="mt-12 p-8 bg-gray-50 rounded-lg">
                            <h3 className="text-xl font-bold font-unbounded mb-4">Support Independent Journalism</h3>
                            <p className="mb-4">
