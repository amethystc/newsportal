...
export const metadata: Metadata = {
  ...
  description: "The page you're looking for doesn't exist. Return to Conflict News Portal homepage for latest conflict and humanitarian news.",
  robots: {
    index: false,
    follow: true,
  },
      ...
      <div className="max-w-2xl w-full text-center">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-500">
            The article you're searching for might have been removed, had its name changed, 
